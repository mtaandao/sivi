...
.pagination-list li a:hover, .pagination-list li.current a,#mn-calendar caption,a.comment-reply-link,#contact-form input[type="submit"], .services a:hover, 
...
.blog-post,  #search-bar button, .btn-primary, .btn, .si-year::after, .post-header::before, #mn-calendar td a{
