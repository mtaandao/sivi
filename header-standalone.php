	...
	<div class="search-wrap">
		...
		<div class="row">
			<div class="col-sm-6 col-sm-offset-3">
				<h4><?php _e('Just Start Typing Text and Press Enter', 'Sivi')?></h4>
...
<!-- Header -->
		<header class="header <?php if ($disSticky) : ?>fixed-top<?php endif; ?>">
			...
			<div class="bottom clearfix">
				...
				<?php endif; ?>
				<a href="" class="responsive-menu-open"><?php _e('Menu', 'Sivi')?><i class="fa fa-bars"></i></a>
				<nav class="main-nav">
					<?php 
					$walker = new My_Walker;
					if(function_exists('mn_nav_menu')):
						mn_nav_menu( 
							array( 
						...
						<ul id="main-menu" class="sm sm-default"><?php mn_list_pages('title_li=&depth=4'); ?></ul>
					<?php endif; ?>	
				</nav> <!-- end .main-nav -->
			</div> <!-- end .bottom -->
		</header> <!-- end .header -->
		<div class="responsive-menu">
			<a href="" class="responsive-menu-close"><?php _e('Close', 'Sivi')?><i class="ion-android-close"></i></a>
			<nav class="responsive-nav"></nav> <!-- end .responsive-nav -->
		</div> <!-- end .responsive-menu -->
		<?php $walker = new pages_from_nav;
		$menu_items = mn_nav_menu( array('container' => false,'items_wrap' => '%3$s', 'depth' => 0, 'menu' =>'primary_nav', 'echo'  => false,'walker' => $walker));
