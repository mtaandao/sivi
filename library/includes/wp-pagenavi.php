...
function mn_pagenavi($before = '', $after = '') {
	global $mndb, $mn_query;
	...
	$pagenavi_options = array(
		...
		'first_text' => __('&larr;','mn-pagenavi'),
		'last_text' => __('&rarr;','mn-pagenavi'),
		'next_text' => __('<span class=" fa fa-chevron-right"></span>','Sivi'),
		'prev_text' => __('<span class="fa fa-chevron-left"></span>','Sivi'),
		'dotright_text' => __('...','mn-pagenavi'),
		'dotleft_text' => __('...','mn-pagenavi'),
		'style' => 1,
		'num_pages' => 5,
		'always_show' => 0,
	...
	$request = $mn_query->request;
	$posts_per_page = intval(get_query_var('posts_per_page'));
	
	$paged = intval(get_query_var('paged'));
	$numposts = $mn_query->found_posts;
	$max_page = intval($mn_query->max_num_pages);
...
function pagenavi_init() {
	...
	$pagenavi_options = array(
		...
		'first_text' => __('','Sivi'),
		'last_text' => __('','Sivi'),
		'next_text' => __('<span class="icon-chevron-right"></span>','Sivi'),
		'prev_text' => __('<span class="icon-chevron-left"></span>','Sivi'),
		'dotright_text' => __('...','Sivi'),
		'dotleft_text' => __('...','Sivi'),
		'style' => 1,
		'num_pages' => 5,
		'always_show' => 0,
		'num_larger_page_numbers' => 3,
