...
$parse_uri = explode( 'main', $_SERVER['SCRIPT_FILENAME'] );
...
<head>
	...
	<script type="text/javascript" src="../../../../../../res/js/tinymce/tiny_mce_popup.js"></script>
...
<?php $page = isset($_GET['page']) ? htmlentities($_GET['page']) : 'sivi'; if( $page == 'sivi' ){
?>
	<script type="text/javascript">
		jQuery(document).ready(function() {
			jQuery('.tabs-1').jQueryTab({
				...
				//classes settings
				tabClass:'sivitabs',                // class of the tabs
		...
		var shortcode = {
			...
			insert: function createSiviShortcode(e, page, dialogwidth, dialogheight) {
	...
	<title>Sivi shortcodes listing</title>
</head>
<body>
<form id="SiviShortcode">
	<div class="tabs-1">
		<ul class="sivitabs">
