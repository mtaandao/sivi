...
/* ***************************************************** 
 * Plugin Name: sivi Social widget
...
class alc_social_widget extends MN_Widget {
	...
	{
		parent::__construct( /* Base ID */'alc-social-widget', /* Name */esc_html__('Sivi - Social links', 'Sivi'), array(      'description' => esc_html__('Display social links', 'Sivi')) );
	}
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'Sivi'); ?></label>
			<input id="<?php echo $this->get_field_id('title'); ?>" type="text" name="<?php echo $this->get_field_name('title'); ?>" value="<?php echo $instance['title']; ?>" class="widefat" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('social_target'); ?>"><?php _e('Target window:', 'Sivi'); ?></label>
        ...
        <p>
			<label for="<?php echo $this->get_field_id('social_placement'); ?>"><?php _e('Placement:', 'Sivi'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('bitbucket'); ?>"><?php _e('Bitbucket:', 'Sivi'); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('dribbble'); ?>"><?php _e('Dribble:', 'Sivi'); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('facebook'); ?>"><?php _e('Facebook:', 'Sivi'); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('flickr'); ?>"><?php _e('Flickr:', 'Sivi'); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('github'); ?>"><?php _e('Github:', 'Sivi'); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('google'); ?>"><?php _e('Google+:', 'Sivi'); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('instagram'); ?>"><?php _e('Instagram:', 'Sivi'); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('linkedin'); ?>"><?php _e('LinkedIn:', 'Sivi'); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('pinterest'); ?>"><?php _e('Pinterest:', 'Sivi'); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('skype'); ?>"><?php _e('Skype:', 'Sivi'); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('twitter'); ?>"><?php _e('Twitter:', 'Sivi'); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id('youtube'); ?>"><?php _e('Youtube:', 'Sivi'); ?></label> 
...
class alc_flickr_widget extends MN_Widget {
	...
	function __construct()
	{
		parent::__construct( /* Base ID */'alc-flickr-widget', /* Name */esc_html__('Sivi - Flickr images', 'Sivi'), array('description' => esc_html__(' Grab and display images from Flickr', 'Sivi')) );
	}
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('flickr_id'); ?>"><?php _e('Flickr ID:', 'Sivi'); ?></label> 
        ...
        <p>
			<label for="<?php echo $this->get_field_id('flickr_nr'); ?>"><?php _e('Number of photos:', 'Sivi'); ?></label> 
...
class alc_works_widget extends MN_Widget {
	...
	function __construct()
	{
		parent::__construct( /* Base ID */'alc-works-widget', /* Name */esc_html__('Sivi - Display latest works', 'Sivi'), array('description' => esc_html__('Display latest portfolio entries', 'Sivi')) );
	}
	...
	function form($instance) {
		...
		$instance = mn_parse_args((array)$instance, $defaults); ?>
		<p>
			<label for="<?php echo $this->get_field_id('post_title'); ?>"><?php _e('Title', 'Sivi'); ?></label>
         ...
         <p>
			<label for="<?php echo $this->get_field_id('featured'); ?>"><?php _e('Show only featured posts', 'Sivi'); ?></label> 
        ...
        <p>
			<label for="<?php echo $this->get_field_id('post_count'); ?>"><?php _e('Number of Posts to show', 'Sivi'); ?></label> 
...
class alc_blogposts_widget extends MN_Widget {
	...
	function __construct()
	{
		parent::__construct( /* Base ID */'alc-blogposts-widget', /* Name */esc_html__('Sivi - Blog Posts', 'Sivi'), array('description' => esc_html__('Display latest blog posts', 'Sivi')) );
	}
	...
	function form($instance) {
        ...
        <p>
         ...
         <p>
			<label for="<?php echo $this->get_field_id('post_category'); ?>"><?php _e('Category (Leave Blank to show from all categories)', 'Sivi'); ?></label> 
			...
			<label for="<?php echo $this->get_field_id('post_thumbs'); ?>"><?php _e('Show thumbnails', 'Sivi'); ?></label>
...
class alc_totalposts_widget extends MN_Widget {
	...
	function __construct()
	{
		parent::__construct( /* Base ID */'alc-totalposts-widget', /* Name */esc_html__('Sivi Popular/Latest posts/Last comments', 'Sivi'), array('description' => esc_html__('Retrieve and display popular/latest posts/latest comments', 'Sivi')) );
	}
	...
	function widget($args, $instance) {
		...
		<div class="widget-tab">
			<ul id="tab" class="nav nav-tabs">
				<li class="active"><a href="#widget-popular" data-toggle="tab"><?php _e('Popular', 'Sivi')?></a></li>
				<li><a href="#widget-recent" data-toggle="tab"><?php _e('Recent', 'Sivi')?></a></li>
				<li><a href="#widget-comments" data-toggle="tab"><?php _e('Comments', 'Sivi')?></a></li>
			</ul>
			<div id="tab-content" class="tab-content">
				...
				<div id="widget-comments" class="tab-pane fade">
					<?php  
					global $mndb;	
					$sql = "SELECT DISTINCT ID, post_title, post_password, comment_ID, comment_post_ID, comment_author, comment_author_email, comment_date, comment_date_gmt, comment_approved, comment_type, comment_author_url, SUBSTRING(comment_content,1,70) AS com_excerpt FROM $mndb->comments LEFT OUTER JOIN $mndb->posts ON ($mndb->comments.comment_post_ID = $mndb->posts.ID) WHERE comment_approved = '1' AND comment_type = '' AND post_password = '' ORDER BY comment_date_gmt DESC LIMIT 5";
					$comments = $mndb->get_results($sql);
					if ($comments):?>
						<ul class="posts-list list-unstyled clearfix">
...
/* ***************************************************** 
 * Plugin Name: sivi Contact Widget
 ...
 */
class alc_Contact_Form extends MN_Widget {
	
	function __construct()
	{
		parent::__construct( /* Base ID */'alc_Contact_Form', /* Name */esc_html__('Sivi - Quick Contact Form', 'Sivi'), array('description' => esc_html__('Quick Contact widget', 'Sivi')) );
	}

	function widget($args, $instance) {
		extract($args);
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Contact Us', 'Sivi') : $instance['title'], $instance);
		$email = apply_filters('widget_title', empty($instance['email']) ? __('', 'Sivi') : $instance['email'], $instance);
		$success = apply_filters('widget_title', empty($instance['success']) ? __('Thank you, e-mail sent.', 'Sivi') : $instance['success'], $instance);
        ...
        ?>                
			<form action="#" method="post" id="contactFormWidget" class="form-horizontal contact-form">
				<div class="form-group">
					<label class="col-sm-3 control-label"><?php _e('Name', 'Sivi')?></label>
					<div class="col-sm-9">
						<input type="text" class="contact-name" name="wname" id="wname">
					</div> <!-- end .col-sm-9 -->
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label"><?php _e('Email', 'Sivi')?></label>
					<div class="col-sm-9">
						<input type="email" class="contact-email" name="wemail" id="wemail">
					</div> <!-- end .col-sm-9 -->
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label"><?php _e('Message', 'Sivi')?></label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<div class="col-sm-9 col-sm-offset-3">
						<input type="submit" id="wformsend" value="<?php _e('Send Message', 'Sivi')?>" class="button solid-button purple" name="wsend" />
					</div> <!-- end .col-sm-9 -->
				</div>
				<div>
	...
	?>
		...
		<div>
        	<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:<br />', 'Sivi'); ?>
			<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" /></label></p>
		</div>
        <div>
        	<label for="<?php echo $this->get_field_id('email'); ?>"><?php _e('Email Address:<br />', 'Sivi'); ?>
        ...
        <div>
        	<label for="<?php echo $this->get_field_id('success'); ?>"><?php _e('Success Message:<br />', 'Sivi'); ?>
...
class sivi_recent_tweets extends MN_Widget {
	public function __construct() {
		parent::__construct(
			'sivi_recent_tweets', // Base ID
			'Sivi - Latest Tweets', // Name
			array( 'description' => __( 'Display recent tweets', 'Sivi' ), ) // Args
		);
	}
...
register_widget('sivi_recent_tweets');
