			...
			<div class="widget-content option-item inside">
				...
				<div class="slider-img">
					<?php if(array_key_exists('image', $slide) ) : ?>
						<?php echo mn_get_attachment_image( $slide['id'] , 'thumbnail' );  ?>
					...
					<?php else : 
						echo mn_get_attachment_image( $slide['id'] , 'full' ); 
						$image_attributes = mn_get_attachment_image_src( $slide['id'] , 'full' );
