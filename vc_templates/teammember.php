...
function vc_teammember($atts, $content=NULL){
	...
	$image = mn_get_attachment_image_src($photo, 'full');
...
/*****************************************************/
vc_map( array(
   "name" => __("Sivi Team Member", "Sivi"),
   "base" => "vc_teammember",
   "class" => "",
   "icon" => "icon-mnb-my_teammember",
   ...
   "params" => array(
      ...
      array(
       ...
       array(
         ...
         "class" => "",
         "heading" => __("Member description", "Sivi"),
         "param_name" => "content"
      ),
	   array(
         "type" => "textfield",     
         "class" => "",
         "heading" => __("Link to Facebook profile(optional)", "Sivi"),
         "param_name" => "fb"
      ),
        array(
         "type" => "textfield",  
         "class" => "",
         "heading" => __("Link to Twitter profile(optional)", "Sivi"),
         "param_name" => "tw"
      ),
        ...
        array(
         "type" => "textfield",    
         "class" => "",
         "heading" => __("Link to Google+ profile(optional)", "Sivi"),
         "param_name" => "gpl"
      ),
        array(
         "type" => "textfield",
